...
export const ShippingAddressSelector = memo<ShippingAddressSelectorProps>(
  ({ selectedDireccionId, onSelectDireccion, error }) => {
    const { user } = useAuth();
    ...
    const handleGuardarDireccion = useCallback(
      async (formData: DireccionFormData) => {
        ...
        try {
          const nuevaDireccion = await direccionService.createDireccion(user.id, formData);
    ...
    return (
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          {hayDirecciones && (
            <button onClick={() => setModalOpen(true)} className={styles.btnAdd} type="button">
        ...
        {!hayDirecciones ? (
          <div className={styles.emptyState}>
            ...
            <p className={styles.emptySubtext}>Agrega una dirección para continuar con el envío</p>
            <button onClick={() => setModalOpen(true)} className={styles.btnPrimary} type="button">
              <span className="material-icons">add</span>
              Agregar Dirección
            </button>
          </div>
              ...
              >
                ...
                <div className={styles.addressContent}>
                  <div className={styles.addressHeader}>
                    ...
                    {direccion.es_predeterminada && <span className={styles.badge}>Predeterminada</span>}
                  </div>
