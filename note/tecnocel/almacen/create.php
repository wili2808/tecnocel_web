            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="codigo" id="codigo" 
                           value="<?php echo isset($codigo_producto) ? $codigo_producto : ''; ?>" placeholder="Ingrese el código del producto" required>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <label for="">Descripción del producto (Color, Nro IMEI):</label>
